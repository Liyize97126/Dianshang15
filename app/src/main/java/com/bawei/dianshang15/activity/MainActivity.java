...
import com.bawei.dianshang15.adapter.GoodsListAdapter;
import com.bawei.dianshang15.base.BaseActivity;
import com.bawei.dianshang15.base.BasePresenter;
import com.bawei.dianshang15.bean.DataBean;
import com.bawei.dianshang15.bean.ResultBean;
import com.bawei.dianshang15.contact.IContact;
import com.bawei.dianshang15.presenter.GoodsPresenter;
import com.bawei.dianshang15.util.MyApplication;
...
public class MainActivity extends BaseActivity {
    ...
    protected void getRefreshGo() {
        //判断是否有网络
        if(VolleyUtil.getVolleyUtil().hasNet()){
            mlssadapter.getList().clear();
            pzshadapter.getList().clear();
            rxxpadapter.getList().clear();
            //发起请求
            initPresenter().request();
